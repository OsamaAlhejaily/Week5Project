        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "john@example.com", "John Doe", "User123", "User" }
                });

            migrationBuilder.InsertData(
                table: "Documents",
                columns: new[] { "Id", "CreatedAt", "FilePath", "Status", "Title", "UserId", "VerificationCode" },
                values: new object[] { 1, new DateTime(2024, 3, 7, 12, 0, 0, 0, DateTimeKind.Unspecified), "/uploads/sample.pdf", "Pending", "Sample Document", 2, "ABC12345" });
